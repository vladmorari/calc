...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(253, 340));
        ...
        jTextField2.setBackground(new java.awt.Color(0, 235, 235));
        ...
        jButton20.setBackground(new java.awt.Color(199, 14, 0));
        jButton20.setFont(new java.awt.Font("Dialog", 0, 36)); // NOI18N
        jButton20.setText("c");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        this.jTextField2.setText(B1 = B1 + this.jButton2.getText());
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        this.jTextField2.setText(  B1 = B1 + this.jButton6.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.jTextField2.setText(B1 = B1 + this.jButton1.getText());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        this.jTextField2.setText(B1 = B1 + this.jButton3.getText());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        this.jTextField2.setText(B1 = B1 + this.jButton4.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        this.jTextField2.setText( B1 = B1 + this.jButton5.getText());
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        this.jTextField2.setText(B1 = B1 + this.jButton9.getText());
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        this.jTextField2.setText( B1 = B1 + this.jButton7.getText());
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        this.jTextField2.setText( B1 = B1 + this.jButton11.getText());

    }//GEN-LAST:event_jButton11ActionPerformed

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:0 
        this.jTextField2.setText(B1 = B1 + this.jButton10.getText());
